            ...
            child: FutureBuilder<List<Supplier>>(
              ...
              builder: (context, snapshot) {
                        ...
                        children: [
                          ...
                          Text(
                            friendlyError(snapshot.error!,
                                fallback: 'Could not load suppliers. Please try again.'),
                ...
                if (suppliers.isEmpty) {
                  return EmptyState(
                    message: _activeOnly || _search.text.isNotEmpty
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: ListTile(
            ...
            Expanded(
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: s.isActive ? null : Colors.black38,
                ),
              ),
            ),
            if (!s.isActive)
        ...
        subtitle: Column(
          ...
          children: [
            ...
            if (s.contactPerson != null && s.contactPerson!.isNotEmpty)
              Row(
                children: [
                  const Icon(Icons.person_outlined, size: 12, color: Colors.black45),
                  const SizedBox(width: 4),
        ...
        isThreeLine: (s.phone != null && s.phone!.isNotEmpty) &&
            (s.contactPerson != null || s.address != null),
      ),
    );
  }
}
