...
class ExpenseRepository {
  Future<List<Map<String, dynamic>>> listExpenses({DateTime? from, DateTime? to}) async {
    ...
    final data = await query.order('expense_date', ascending: false).order('created_at', ascending: false).limit(300) as List<dynamic>;
  ...
  Future<String> recordExpense({
    ...
    final id = await sb.rpc('record_expense', params: {
      'p_category': category,
      'p_amount': amount,
